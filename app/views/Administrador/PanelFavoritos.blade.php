				...
				<tbody>
					...
					<tr>
						...
						<td style="width:10%" class="action-td">
							<div>
								<p><a href="javascript:;" onclick="$('#ElimFav').modal('toggle'); document.getElementById('EliminarF').setAttribute('data-artic', {{ $articulo['id'] }})" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Eliminar Favorito </a></p>
							</div>
						</td>
					</tr>
					@endforeach
